...
const llavePrivada = "e0eaab0558cac71f5b7efb11668f324000a76ab3843d2e5becfb201cbec97adc";

// Public key = (Private key * G) mod p;
// The 'mod' is done internally within the library

const publicKey = curve.g.mul(llavePrivada);

console.log("Public Key", publicKey.encode("hex"));
// Non-compact version of the public key
